...
public class MapsActivity extends FragmentActivity implements
    ...
    private int ProximityRadus = 10000 ;
    ...
    private String  getUrl ( double latitude ,double longitude, String nearbyPlaces)
    {
        ...
        googleURL.append("loctaion=" +latitude+"," +longitude);
        googleURL.append("&radius="+ ProximityRadus);
        googleURL.append("&type" + nearbyPlaces);
        googleURL.append("&sensor=true");
        googleURL.append("&key="+ "AIzaSyChj9gTLV_u-bTsETKQNhxxDRu8aug6XeM");
